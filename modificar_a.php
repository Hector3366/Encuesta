...
<body>
	...
	<main id="main" class="main">
		...
		$id = $_REQUEST['id'];
		$query = "SELECT * FROM alumnos WHERE no_control='$id'";
						...
						<div class="row">
							...
							<div class="col-9">
								...
								<div class="form-group row">
									...
									<div class="col-8">
										<input type="text" name="no_control" value="<?php echo $row['no_control']; ?>">
									</div>
								</div><br>
								<div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-8">
										<input type="text" name="apellido_m" value="<?php echo $row['apellido_m']; ?>">
									</div>
								</div><br>
								<div class="form-group row">
									<label for="semestre" class="col-4"><b>Semestre</b></label>
									<div class="col-8">
									<input type="text" name="id_semestre" value="<?php echo $row['id_semestre']; ?>">
									</div>
								</div><br>
								<div class="form-group row">
									<label for="grupo" class="col-4"><b>Grupo</b></label>
									<div class="col-8	">
									<input type="text" name="id_grupo" value="<?php echo $row['id_grupo']; ?>">
									</div>
								</div><br>
...
$query= "UPDATE alumnos SET  nombre='$NOM', apellido_p='$AP', apellido_m='$AM', id_semestre='$SEM', id_grupo='$GPO' WHERE no_control='$ID'";
$resultado=$conexion->query($query);
if($resultado){
    echo "<script> swal({
		title: 'CORRECTO',
		...
		window.location = 'modificar_alumnos.php';
	});
	  </script>";
}else{
    echo "<script> swal({
		title: 'ERROR',
		text: 'Alumno no Actualizado',
		type: 'error',
	  });</script>";
}
