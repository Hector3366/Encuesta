				...
				<div class="row">
					...
					box-shadow: 5px 5px 8px rgba(0, 0, 0, 0.582);">
						<center>
							...
							color: white;
							padding: 5px;">
								<b>REGISTRAR MAESTROS</b>
							</h1>
						</center>
						<div class="row">
							<div class="col-3">
								<br><br><br>
								<img class="img-fluid" src="img/ingresar.png">
							</div>
							...
							<div class="col-9">
								...
								<div class="form-group row">
									<label for="imagen" class="col-4"><b>Imagen</b></label>
									<div class="col-8">
...
if (isset($_POST['btn1'])) {
	...
	$separador = ' ';
	$separada = explode($separador, $NOM);
	$p1 = $separada[0];
	$us = $p1 . '.' . $AP;
	$query = "INSERT INTO maestros (nombre,apellido_p,apellido_m,imagen,id_status) VALUES('$NOM','$AP','$AM','$IMG','$STATUS')";
	$resultado = $conexion->query($query);

	$query = "INSERT INTO usuarios(usuario,contraseña,id_cargo) VALUES('$us','$pass','$CARGO')";
	$resultado = $conexion->query($query);

	if ($resultado) {
		echo "<script> swal({
			title: 'CORRECTO',
			text: 'Maestro Guardado Exitosamente',
			type: 'success',
		  });</script>";
	} else {
		echo "<script> swal({
