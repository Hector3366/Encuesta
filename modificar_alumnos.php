...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <h1 style="padding-left: 575px;"><b>MODIFICAR ALUMNOS</b></h1>
        </div><!-- Fin Logo -->
    </header><!-- Fin Header -->
    <!-- ======= Sidebar ======= -->
            ...
            <div class="table-responsive" id="mydatatable-container">
                <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td align="center"><?php echo $row['no_control']; ?></td>
                                <td align="center"><?php echo $row['nombre']; ?></td>
                                <td align="center"><?php echo $row['apellido_p']; ?></td>
                                <td align="center"><?php echo $row['apellido_m']; ?></td>
                                <td align="center"><?php echo $row['semestre']; ?></td>
                                <td align="center"><?php echo $row['grupo']; ?></td>
                                <th align="center"><a class="btn btn-primary" href="modificar_a.php?id=<?php echo $row['no_control']; ?>" role="button"><i class="bi bi-pencil-fill"></i> MODIFICAR</a></th>
                            </tr>
                        <?php
                        }
                        ?>
