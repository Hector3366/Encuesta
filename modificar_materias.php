...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <h1 style="padding-left: 585px;"><b>MODIFICAR MATERIAS</b></h1>
        </div><!-- Fin Logo -->
    </header><!-- Fin Header -->
	<!-- ======= Sidebar ======= -->
    ...
    <main id="main" class="main">
        <section class="section dashboard">
            <center>
                <div class="table-responsive" id="mydatatable-container" style="width: 75%;">
                    ...
                    <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM materias ORDER BY materias.materia ASC    ";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <th><a class="btn btn-primary" href="modificar_materia.php?id=<?php echo $row['id_materia']; ?>" role="button"><i class="bi bi-pencil-fill"></i> MODIFICAR</a></th>
                                </tr>
                            <?php
                            }
                            ?>
