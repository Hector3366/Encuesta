...
<body>
	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="d-flex align-items-center justify-content-between">
			<h1 style="padding-left: 625px;"><b>VER ASIGNACIONES</b></h1>
		</div><!-- Fin Logo -->
	</header><!-- Fin Header -->
	<!-- ======= Sidebar ======= -->
			...
			<div class="table-responsive" id="mydatatable-container">
				<table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
					...
					<tbody>
						...
						$query = "SELECT maestros.nombre, maestros.apellido_p, maestros.apellido_m, semestre.semestre, grupo.grupo, materias.materia, periodo.periodo 
                                FROM asignar 
						...
						?>
							<tr>
								...
								<td style="width: 230px;"><?php echo $row['materia']; ?></td>
								<td align="center" style="width: 95px;"><?php echo $row['semestre']; ?></td>
								<td align="center" style="width: 95px;"><?php echo $row['grupo']; ?></td>
