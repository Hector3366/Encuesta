...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <h1 style="padding-left: 575px;"><b>ELIMINAR MAESTROS</b></h1>
    </div><!-- Fin Logo -->
  </header><!-- Fin Header -->
	<!-- ======= Sidebar ======= -->
...
<script>
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                            url: 'proceso_eliminar_maestros.php',
                            type: 'POST',
                            data: 'delete=' + id_m,
                            dataType: 'json'
                        })
                        ...
                        .fail(function() {
                            swal('Oops...', 'No se puede eliminar ya que actualmente tiene clases asignadas', 'error');
                        });
                });
            },
    ...
    function readProducts() {
        $('#load-products').load('eliminar_m.php');
    }
</script>
