...
<body>
	...
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="d-flex align-items-center justify-content-between">
			<h1 style="padding-left: 575px;"><b>MODIFICAR MAESTROS</b></h1>
		</div><!-- Fin Logo -->
	</header><!-- Fin Header -->
	<!-- ======= Sidebar ======= -->
					...
					<tbody>
						...
						?>
							<tr>
								...
								<th align="center"><a class="btn btn-primary" href="modificar_m.php?id=<?php echo $row['id_maestros']; ?>" role="button"><i class="bi bi-pencil-fill"></i> MODIFICAR</a></th>
							</tr>
						<?php
						}
						?>
